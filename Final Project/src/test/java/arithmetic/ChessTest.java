...
public class ChessTest {
	...
	private static Move gameMove;
	private static BoardUnit gameBoard;
	private static Alliance gameAlliance;
	...
	public void testMove() {
		King blackKing = gameMove.getBlackKing();
		
		blackKing.moveTo(4, 4);
		Queen queen1 = gameMove.addQueen(WHITE,3,3);
		Queen queen2 = gameMove.addQueen(WHITE,5,5);
		
		assertTrue(gameMove.isCheckmate(BLACK));
		
		gameMove.removePiece(queen1);
		assertFalse(gameMove.isCheckmate(BLACK));
	}
	...
	public void testBoard() {
		King blackKing = gameBoard.getBlackKing();
		
		blackKing.moveTo(4, 4);
		Queen queen1 = gameBoard.addQueen(WHITE,3,3);
		Queen queen2 = gameBoard.addQueen(WHITE,5,5);
		
		assertTrue(gameBoard.isCheckmate(BLACK));
		
		gameBoard.removePiece(queen1);
		assertFalse(gameBoard.isCheckmate(BLACK));
	}
	...
	public void testAlliance() {
		King blackKing = gameAlliance.getBlackKing();
		
		blackKing.moveTo(4, 4);
		Queen queen1 = gameAlliance.addQueen(WHITE,3,3);
		Queen queen2 = gameAlliance.addQueen(WHITE,5,5);
		
		assertTrue(gameAlliance.isCheckmate(BLACK));
		
		gameAlliance.removePiece(queen1);
		assertFalse(gameAlliance.isCheckmate(BLACK));
	}
